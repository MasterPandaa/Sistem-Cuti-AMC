...
$(function() {
    ...
    $("#tabel-aktif").DataTable({
        ...
        "autoWidth": true,
        "buttons": ["colvis"],
    }).buttons().container().appendTo('#tabel-aktif_wrapper .col-md-6:eq(0)');

    $("#tabel-tidak-aktif").DataTable({
        "responsive": true,
        "lengthChange": true,
        "autoWidth": true,
        "buttons": ["colvis"],
    }).buttons().container().appendTo('#tabel-tidak-aktif_wrapper .col-md-6:eq(0)');
    ...
    $('#tabel-cuti').DataTable({
        ...
        "autoWidth": false,
        "responsive": true,
        // Hapus buttons property untuk menghilangkan Column Visibility
    });
});
</script>
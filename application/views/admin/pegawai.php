...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                                            ...
                                            <table id="tabel-aktif" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="<?= $row_class ?>">
                                                        ...
                                                        <td><?= $jenis_kelamin ?></td>
                                                        <td>
                                                    <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit_data_pegawai<?=$id_user?>">
            ...
            <div class="modal fade" id="edit_data_pegawai<?= $p['id_user'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url(); ?>Pegawai/edit_pegawai" method="POST" id="formEditPegawai<?= $p['id_user'] ?>">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?=base_url();?>Pegawai/tambah_pegawai" method="POST" id="formTambahPegawai">
                                <div class="form-group">
                                    <label for="nama_lengkap">Nama Lengkap*</label>
    ...
    $(document).ready(function() {
        var table = $('#tabel-aktif').DataTable({
            ...
            "order": [[1, 'asc']] // Default sort by nama pegawai column
        });
